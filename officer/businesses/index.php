...
try {
    ...
    $stats = [
        'total_businesses' => (int)($statsResult['total_businesses'] ?? 0),
        'active_businesses' => (int)($statsResult['active_businesses'] ?? 0),
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content" id="mainContent">
            ...
            if ($flash && is_array($flash) && isset($flash['type']) && isset($flash['message']) && !empty($flash['message'])): 
            ?>
