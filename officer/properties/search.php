 ...
 * Enhanced with outstanding balance calculation and full officer permissions
 */
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="search-instructions fade-in">
            ...
            <ul>
                ...
                <li><strong>Actions:</strong> View details, record payments, edit accounts, and generate bills</li>
                <?php if (!$debugMode): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <?php endif; ?>
                                                <!-- Officer can edit accounts -->
                                                <a href="../../admin/<?php echo $result['type'] === 'business' ? 'businesses' : 'properties'; ?>/edit.php?id=<?php echo $result['id']; ?>" 
                                                   class="action-btn edit">
                                                    <i class="fas fa-edit"></i>
                                                    <span class="icon-edit" style="display: none;"></span>
                                                    Edit
                                                </a>
                                                <!-- Officer can generate bills -->
                                                <a href="../billing/generate.php?type=<?php echo $result['type']; ?>&id=<?php echo $result['id']; ?>" 
    ...
    <script>
        ...
        function displayAccountDetails(data) {
            ...
            detailsHtml += `
                ...
                <div style="display: flex; gap: 10px; justify-content: center; margin-top: 30px; padding-top: 20px; border-top: 2px solid #e2e8f0; flex-wrap: wrap;">
                    ...
                    `}
                    <a href="../../admin/${data.type === 'business' ? 'businesses' : 'properties'}/edit.php?id=${data.business_id || data.property_id}" 
                       style="background: #ed8936; color: white; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 8px; transition: all 0.3s; min-width: 140px; justify-content: center;"
                       onmouseover="this.style.background='#dd6b20'; this.style.transform='translateY(-2px)'"
                       onmouseout="this.style.background='#ed8936'; this.style.transform='translateY(0)'">
                        <i class="fas fa-edit"></i>
                        <span class="icon-edit" style="display: none;"></span>
                        Edit Account
                    </a>
                    <a href="../billing/generate.php?type=${data.type}&id=${data.business_id || data.property_id}" 
                       style="background: #805ad5; color: white; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 8px; transition: all 0.3s; min-width: 140px; justify-content: center;"
                       onmouseover="this.style.background='#6b46c1'; this.style.transform='translateY(-2px)'"
                       onmouseout="this.style.background='#805ad5'; this.style.transform='translateY(0)'">
                        <i class="fas fa-file-invoice"></i>
                        <span class="icon-bill" style="display: none;"></span>
                        Generate Bill
                    </a>
        ...
        console.log('✅ Officer search accounts page initialized successfully with enhanced permissions');
    </script>
</body>
</html>